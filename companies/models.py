...
class Vacancy(models.Model):
    ...
    experience = models.CharField(max_length=255, blank=True, null=True, verbose_name='Опыт работы')
    employment_type = models.CharField(max_length=255, choices=EMPLOYMENT_CHOICES, default='full_time', verbose_name='Тип занятости')
    schedule = models.CharField(max_length=255, choices=SCHEDULE_CHOICES, default='day', verbose_name='График работы')
    working_hours = models.CharField(max_length=255, blank=True, null=True, verbose_name='Рабочие часы')
